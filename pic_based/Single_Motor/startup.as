	...
	; Compiler options:
	;
	; -oAutomatic_water_pump_Single_motor.cof \
	; -mAutomatic_water_pump_Single_motor.map --summary=default \
	; --output=default Single_Motor.p1 --chip=16F877A -P --runtime=default \
